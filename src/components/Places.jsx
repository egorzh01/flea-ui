      ...
      {places.length === 0 ? (
        ...
        <div className="scrollarea m-auto flex w-2/3 flex-wrap justify-center gap-3 overflow-y-auto">
          {places.map((place, index) => (
            <div
              key={index}
              className="flex h-fit w-fit cursor-pointer flex-col items-center rounded-xl border p-3 hover:bg-[var(--dark)] hover:text-[var(--light)] dark:hover:bg-[var(--light)] dark:hover:text-[var(--dark)]"
            >
